...
final class TestSuiteSorter
{
    ...
    /**
     * Order test by @size annotation 'small', 'medium', 'large'
     *
     * @var int
     */
    ...
    /**
     * @var string[] A list of normalized names of test before reordering
     */
    private $originalExecutionOrder = [];

    /**
     * @var string[] A list of normalized names of test affected by reordering
     */
    ...
    /**
     * Comparator callback function to sort test for "reach failure as fast as possible":
     * 1. sort test by defect weight defined in self::DEFECT_SORT_WEIGHT
     * 2. when test are equally defective, sort the fastest to the front
     * 3. do not reorder successful test
     *
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    ...
    /**
     * Compares test duration for sorting test by duration ascending.
     *
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
     ...
     * The algorithm will leave the test in original running order when it can.
     * For more details see the documentation for test dependencies.
     *
     * Short description of algorithm:
     * 1. Pick the next Test from remaining test to be checked for dependencies.
     * 2. If the test has no dependencies: mark done, start again from the top
     * 3. If the test has dependencies but none left to do: mark done, start again from the top
     * 4. When we reach the end add any leftover test to the end. These will be marked 'skipped' during execution.
     *
