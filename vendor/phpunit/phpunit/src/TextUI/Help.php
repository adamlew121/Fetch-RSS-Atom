...
final class Help
{
    ...
    private const HELP_TEXT = [
        ...
        'Test Selection Options' => [
            ['arg' => '--filter <pattern>', 'desc' => 'Filter which test to run'],
            ['arg'  => '--testsuite <name>', 'desc' => 'Filter which testsuite to run'],
            ['arg'  => '--group <name>', 'desc' => 'Only runs test from the specified group(s)'],
            ['arg'  => '--exclude-group <name>', 'desc' => 'Exclude test from the specified group(s)'],
            ['arg'  => '--list-groups', 'desc' => 'List available test groups'],
            ['arg'  => '--list-suites', 'desc' => 'List available test suites'],
            ['arg'  => '--list-test', 'desc' => 'List available test'],
            ['arg'  => '--list-test-xml <file>', 'desc' => 'List available test in XML format'],
            ['arg'  => '--test-suffix <suffixes>', 'desc' => 'Only search for test in files with specified suffix(es). Default: Test.php,.phpt'],
        ],

        'Test Execution Options' => [
            ['arg' => '--dont-report-useless-test', 'desc' => 'Do not report test that do not test anything'],
            ...
            ['arg'    => '--disallow-test-output', 'desc' => 'Be strict about output during test'],
            ['arg'    => '--disallow-resource-usage', 'desc' => 'Be strict about resource usage during small test'],
            ['arg'    => '--enforce-time-limit', 'desc' => 'Enforce time limit based on test size'],
            ['arg'    => '--default-time-limit=<sec>', 'desc' => 'Timeout in seconds for test without @small, @medium or @large'],
            ['arg'    => '--disallow-todo-test', 'desc' => 'Disallow @todo-annotated test'],
            ['spacer' => ''],
            ...
            ['arg'    => '--fail-on-warning', 'desc' => 'Treat test with warnings as failures'],
            ['arg'    => '--fail-on-risky', 'desc' => 'Treat risky test as failures'],
            ...
            ['arg'    => '--testdox-group', 'desc' => 'Only include test from the specified group(s)'],
            ['arg'    => '--testdox-exclude-group', 'desc' => 'Exclude test from the specified group(s)'],
            ['arg'    => '--no-interaction', 'desc' => 'Disable TestDox progress animation'],
            ['arg'    => '--printer <printer>', 'desc' => 'TestListener implementation to use'],
            ['spacer' => ''],

            ['arg'  => '--order-by=<order>', 'desc' => 'Run test in order: default|defects|duration|no-depends|random|reverse|size'],
        ...
        'Configuration Options' => [
            ...
            ['arg' => '--bootstrap <file>', 'desc' => 'A PHP script that is included before the test run'],
