...
class Command
{
        ...
        foreach ($this->options[0] as $option) {
            switch ($option[0]) {
                ...
                case '--generate-configuration':
                    ...
                    print 'Tests directory (relative to path shown above; default: test): ';
    ...
    private function handleListTestsXml(TestSuite $suite, string $target, bool $exit): int
    {
        ...
        \printf(
            'Wrote list of test that would have been run to %s' . \PHP_EOL,
            $target
        );
