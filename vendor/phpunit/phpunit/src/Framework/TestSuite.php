...
class TestSuite implements \IteratorAggregate, SelfDescribing, Test
{
    ...
    /**
     * The number of test in the test suite.
     *
     * @var int
     */
    ...
    /**
     * Last count of test in this suite.
     *
     * @var null|int
     */
    ...
    /**
     * Adds the test from the given class to the suite.
     *
     ...
     *
     * If the named file cannot be read or there are no new test that can be
    ...
    /**
     * Set test groups of the test case
     */
    ...
    /**
     * Runs the test and collects their result in a TestResult.
     *
    ...
    /**
     * Returns the test as an enumeration.
     *
     * @return Test[]
     */
