...
final class TestSuiteSorterTest extends TestCase
{
     ...
     * - it has five test 'testOne' ... 'testFive'
    ...
    public function defectsSorterOptionsProvider(): array
    {
        return [
            ...
            // Make sure the dependency resolver is not confused by failing test.
    ...
    public function testCanHandleSuiteWithEmptyTestCase(): void
    {
        ...
        $this->assertSame('No test found in class "EmptyTestCaseTest".', $suite->tests()[0]->tests()[0]->getMessage());
    }
