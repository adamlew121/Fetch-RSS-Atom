...
final class ConfigurationTest extends TestCase
{
    ...
    public function testConfigurationForSingleTestSuiteCanBeLoaded(): void
    {
        ...
        $this->assertSame(TEST_FILES_PATH . 'test/first', $first->directories()->asArray()[0]->path());
    ...
    public function testConfigurationForMultipleTestSuitesCanBeLoaded(): void
    {
        ...
        $this->assertSame(TEST_FILES_PATH . 'test/second', $second->directories()->asArray()[0]->path());
        ...
        $this->assertSame(TEST_FILES_PATH . 'test/file.php', $second->files()->asArray()[0]->path());
        ...
        $this->assertSame(TEST_FILES_PATH . 'test/second/_files', $second->exclude()->asArray()[0]->path());
    }
}
