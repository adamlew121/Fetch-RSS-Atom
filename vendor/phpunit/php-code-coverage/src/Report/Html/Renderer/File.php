        ...
        foreach ($codeLines as $line) {
            ...
            if (\array_key_exists($i, $coverageData)) {
                ...
                if ($coverageData[$i] === null) {
                    ...
                    $lineCss        = 'covered-by-large-test';
                    $popoverContent = '<ul>';

                    if ($numTests > 1) {
                        $popoverTitle = $numTests . ' test cover line ' . $i;
                    } else {
                        $popoverTitle = '1 test covers line ' . $i;
                    }

                    foreach ($coverageData[$i] as $test) {
                        if ($lineCss == 'covered-by-large-test' && $testData[$test]['size'] == 'medium') {
                            $lineCss = 'covered-by-medium-test';
                        } elseif ($testData[$test]['size'] == 'small') {
                            $lineCss = 'covered-by-small-test';
                        }
                        ...
                        switch ($testData[$test]['status']) {
                            case 0:
                                switch ($testData[$test]['size']) {
                                    case 'small':
                                        $testCSS = ' class="covered-by-small-test"';

                                        break;

                                    case 'medium':
                                        $testCSS = ' class="covered-by-medium-test"';

                                        break;

                                    default:
                                        $testCSS = ' class="covered-by-large-test"';
